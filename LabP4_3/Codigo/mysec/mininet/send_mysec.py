...
def print_mysec(pkt):
    ...
    if MySec in pkt:
        ...
        print("=" * 60)
        print(f"  process_time_sw1      : {m.process_time_sw1} ns  (latencia egress S1, camino vuelta s2→h1)")
        print(f"  process_time_sw2      : {m.process_time_sw2} ns  (latencia egress S1, camino ida h1→s2)")
